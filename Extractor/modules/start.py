...
buttons = InlineKeyboardMarkup([
    [
        ...
        InlineKeyboardButton("Contact ☎️", url="https://t.me/TheDiabloContactBot")
    ]])
...
async def handle_callback(_, query):
    ...
    if query.data == "home_":
        ...
        without_buttons = main_func.get_page(0, core_func.WithoutAppDict, DictID="WithoutID-Pass", back_data="tools_", query=query, withoutIdPass=False)
        await query.message.edit_text(script.TOOLS_TEXT, reply_markup=without_buttons)
        ...
        if data in core_func.appNameDict or data in appxmethod.appxapis or data in core_func.videoCryptDict or data in core_func.WithoutAppDict:
            if data in appxmethod.appxapis:
                ...
                await vdocrypt.start_login(_, query.message, user_id, True)
