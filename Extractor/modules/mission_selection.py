...
class Mission_Selection:
    def __init__(self):
        self.v_count = 0
        self.p_count = 0
        self.DEFAULT_BASE = "0117108641864451"
        self.BASE = "1171086418644515_746"
...
async def mission_selection(app, query, message):
    extractor = Mission_Selection()
