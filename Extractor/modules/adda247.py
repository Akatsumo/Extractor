        ...
        async with aiohttp.ClientSession() as session:
            ...
            try:
                ...
                if "*" in input1.text:
                    ...
                    # output["jwtToken"] if output["jwtToken"] else
                    token = "eyJhbGciOiJIUzUxMiJ9..mOw-oAV4W9RpfhmkFgMXGWjNrqvhnLqbYb7JUWM7DhtiiSO_Ehu9FmnDaGRHSYUos0AbhmnJR_f-K_HanUA0pQ"
