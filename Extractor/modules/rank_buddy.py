...
class Rank_Buddy:
    def __init__(self):
        ...
        self.BASE = "1171086418644515_583"
        ...
        try:
            ...
            if content.get('file_type') == '3':
                if content.get('is_drm') == '1':
                    self.v_count += 1
                    url = f"https://rankbuddy.in/drm/{content.get('vdc_id')}/{headers.get('userid')}"
...
async def rank_buddy(app, query, message):
    extractor = Rank_Buddy()
