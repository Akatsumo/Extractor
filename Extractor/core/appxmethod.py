...
appxapis = {
    ...
    "Anushasanclasseswhiteboardacademy_": {
    ...
    "Clatiansaguideforlawaspirants_": {
    ...
    "Competitionacademydigitalclasses_": {
    ...
    "Cosmossikaraninstituteofgeography_": {
    ...
    "Crackparikshachandanlogicsold_": {
    ...
    "Currentaffairsbyshrikanttayade_": {
    ...
    "Defencesadhanacdscapfacndaafcat_": {
    ...
    "Hanumanshindesprashasancareeracademy_": {
    ...
    "Jiddpolicetrainingbymaheshsir_": {
    ...
    "Krishiparikshaicaribpsupsccuetexametc_": {
    ...
    "Lawshalabyhalfpacelearnatyourownpace_": {
    ...
    "Loksevaacademypublicationbook_": {
    ...
    "Ltrammanoharsinghintercollege_": {
    ...
    "Mahavirpublisheranddistributors_": {
    ...
    "Missionkhakionlinelearningapp_": {
    ...
    "Odiaspacegovtexampreparationapp_": {
    ...
    "Radhekrishnaacademyeducationapp_": {
    ...
    "Sachindhawalesmathsandreasoningacademy_": {
    ...
    "Shrenikjainengineeringsimplified_": {
