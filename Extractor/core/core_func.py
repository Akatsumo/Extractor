...
testpaper_free, jincjodhpur_free, careerwill_free, geologicalConcepts_free, selectionWay_free, taiyariKarlo_free, sscpinnacle_free, chandraInstitute_free, videocrypt_free)
...
WithoutAppDict = {
    ...
    "videocrypt_": {"name": "Videocrypt", "BatchAcess": True, "func": videocrypt_free.videocrypt_access},
